...
export default function TrackParameterGuidePage() {
  const t = useTranslations('Guide.trackGuidePage');
  const actionTitle = useTranslations('Guide.runningGuidePage')('actionTitle'); // Reuse actionTitle from runningGuidePage since it's common
      ...
      <div className='flex flex-col w-full h-full self-start p-8 md:p-12 gap-8 overflow-y-auto custom-scrollbar max-w-4xl mx-auto'>
        ...
        <article className='prose prose-slate dark:prose-invert max-w-none space-y-12'>
          ...
          <section className='space-y-6'>
            ...
            {/* Dynamic CSV uploads */}
            <div className='space-y-4'>
              <p className='body-big-bold text-foreground'>{t('inputUploadTitle')}</p>
              <p className='text-muted-foreground leading-7'>
                {t('inputUploadDesc')}
              </p>
            </div>
            ...
            {/* Action buttons */}
            <div className='space-y-4'>
              <p className='body-big-bold text-foreground'>{actionTitle}</p>
            ...
            {/* Slope Options Container */}
            <div className='space-y-4 pt-4'>
              <p className='heading-5 tracking-tight text-foreground border-l-4 border-primary pl-4'>
                {t('slopeOptionsTitle')}
              </p>
              <p className='text-muted-foreground leading-7'>
                {t('slopeOptionsDesc')}

...
export default function ElectricalParameterGuidePage() {
  const t = useTranslations('Guide.electricalGuidePage');
  const actionTitle = t('actionTitle');
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  >
                    ...
                    <p className="body-small-regular text-muted-foreground leading-6">
                      {desc}
                    </p>
                  </div>
                ))}
